...
## Solution
We developed a data-driven pipeline that replaces subjective reporting with objective modeling:
...
## Recommendation
- Prioritize post-harvest infrastructure (e.g., drying beds) to improve quality and effective yield
